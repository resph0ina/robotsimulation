...
class SEAJointState(genpy.Message):
  _md5sum = "9003044dea30e406b67ea8ee3e388315"
...
"""
  __slots__ = ['header','name','position','velocity','effort','gravity_model_effort','hysteresis_model_effort','crosstalk_model_effort']
  _slot_types = ['std_msgs/Header','string[]','float64[]','float64[]','float64[]','float64[]','float64[]','float64[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,name,position,velocity,effort,gravity_model_effort,hysteresis_model_effort,crosstalk_model_effort
